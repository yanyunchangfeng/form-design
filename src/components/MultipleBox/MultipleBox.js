...
class MultipleBox extends PureComponent {
	render() {
			...
			<div className={`wf-component wf-component-textfield ${status}`}>
				...
				<div className="wf-view">
					<div className="wf-field">
						...
						<span className="wf-field-placeholder">{tipValue + (verifyValue ? '（必填）' : '')}</span>
					</div>
				</div>
			</div>
		);
...
export default WrapperDrop(WrapperDrag(MultipleBox));
